...
import RoomFragnances from "../catalogPage/room-fragnances";

const RoomFragnanceDetail = () => {
   const { id } = useParams();
   ...
   const apiUrl = baseUrl + `/api/room-fragrances/${id}/`;
...
export default RoomFragnanceDetail;
